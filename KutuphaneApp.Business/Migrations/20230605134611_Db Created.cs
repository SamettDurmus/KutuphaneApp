    ...
    public partial class DbCreated : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cateogorys", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookCateogory", x => new { x.BooksId, x.CateogoriesId });
                    table.ForeignKey(
                        name: "FK_BookCateogory_Books_BooksId",
                        column: x => x.BooksId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BookCateogory_Cateogorys_CateogoriesId",
                        column: x => x.CateogoriesId,
                        principalTable: "Cateogorys",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    PhotoPaths = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Photos_BookDetails_BookDetailId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookCateogory_CateogoriesId",
                table: "BookCateogory",
                column: "CateogoriesId");
