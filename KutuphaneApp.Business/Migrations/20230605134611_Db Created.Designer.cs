...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookCateogory", b =>
                {
                    ...
                    b.HasKey("BooksId", "CateogoriesId");

                    b.HasIndex("CateogoriesId");

                    b.ToTable("BookCateogory");
                });
            ...
            modelBuilder.Entity("KutuphaneApp.Entity.Concrate.UserRole", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("BookCateogory", b =>
                {
                    b.HasOne("KutuphaneApp.Entity.Concrate.Book", null)
                        .WithMany()
                        .HasForeignKey("BooksId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KutuphaneApp.Entity.Concrate.Cateogory", null)
                        .WithMany()
                        .HasForeignKey("CateogoriesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
